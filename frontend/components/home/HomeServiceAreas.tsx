        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {clusters.map((cluster) => {
            ...
            return (
              <div
                key={cluster.title}
                className="bg-white rounded-2xl border border-slate-200/90 p-6 sm:p-8 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.06)] hover:shadow-md transition-all flex flex-col items-center justify-between text-center min-h-[190px]"
              >
