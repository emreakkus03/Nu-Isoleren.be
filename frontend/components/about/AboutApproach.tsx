      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          <div className="lg:col-span-6">
            ...
            <h2 className="mt-3 text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-950 tracking-tight leading-[1.15] max-w-2xl">
              {t('title')}
            </h2>
          </div>

          <div className="lg:col-span-6">
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed max-w-2xl mt-4">
              {t('description')}
            </p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 lg:gap-14 mt-14 md:mt-20">
