  ...
  return (
    <section className="w-full py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#C82024] rounded-2xl p-8 sm:p-12 lg:p-16 flex flex-col md:flex-row md:items-center md:justify-between gap-8 shadow-sm">
          
          <div className="max-w-2xl">
            <h2 className="text-2xl sm:text-3xl lg:text-3xl font-extrabold text-white tracking-tight leading-snug mb-3">
              {title || t('title')}
            </h2>
